...
export default function AboutPage() {
  const teamMembers = [
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20businesswoman%20portrait%2C%20confident%20female%20CEO%20in%20business%20attire%2C%20corporate%20headshot%2C%20modern%20professional%20photography%2C%20clean%20background%2C%20leadership%20executive&width=300&height=300&seq=ceo-portrait&orientation=squarish',
      description: 'With over 15 years of e-commerce experience, Sarah founded LaRosa Hub to revolutionize online shopping.'
    },
    {
      name: 'Michael Chen',
      position: 'Head of Technology',
      image: 'https://readdy.ai/api/search-image?query=Tech%20professional%20portrait%2C%20male%20software%20engineer%20headshot%2C%20modern%20technology%20leader%2C%20professional%20business%20photo%2C%20clean%20background%2C%20innovation%20expert&width=300&height=300&seq=cto-portrait&orientation=squarish',
      description: 'Michael leads our technology team, ensuring our platform delivers the best user experience possible.'
    },
    {
      name: 'Emily Rodriguez',
      position: 'Customer Experience Director',
      image: 'https://readdy.ai/api/search-image?query=Customer%20service%20professional%20portrait%2C%20friendly%20businesswoman%20headshot%2C%20customer%20experience%20manager%2C%20professional%20corporate%20photo%2C%20clean%20background&width=300&height=300&seq=cx-portrait&orientation=squarish',
      description: 'Emily is passionate about creating exceptional customer experiences and building lasting relationships.'
    }
  ];
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'We prioritize the security of your data and ensure safe, reliable transactions every time.'
    },
    {
      icon: 'ri-lightbulb-line',
      title: 'Innovation',
      description: 'We continuously innovate to bring you the latest products and shopping technologies.'
    },
    {
      icon: 'ri-earth-line',
      title: 'Sustainability',
      description: 'We are committed to sustainable practices and partnering with eco-conscious brands.'
    }
  ];
  ...
  const milestones = [
    {
      year: '2020',
      title: 'LaRosa Hub Founded',
      description: 'Started with a vision to create the best online shopping experience in South Africa.'
    },
    {
      year: '2021',
      title: '10,000+ Products',
      description: 'Expanded our catalog to include over 10,000 carefully curated products across multiple categories.'
    },
    {
      year: '2022',
      title: '100,000 Customers',
      description: 'Reached the milestone of serving over 100,000 satisfied customers nationwide.'
    },
    {
      year: '2023',
      title: 'Mobile App Launch',
      description: 'Launched our mobile app, making shopping even more convenient for our customers.'
    },
    {
      year: '2024',
      title: 'Sustainability Initiative',
      description: 'Launched our green packaging initiative and carbon-neutral shipping options.'
    }
  ];
